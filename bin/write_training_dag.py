...
VARS train_{0}_{1}_{2}{6} nodename="train_{0}_{1}_{2}{6}" pycmd="do_the_fit_NN.py --pca-dataset {3} --model-directory {4} {5}"
...
if not config['model-dir'].endswith('/'):  config['pca-dataset']+='/'
