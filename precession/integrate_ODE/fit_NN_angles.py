...
dataset_generator = angle_generator(t_min = 10, N_times = 500, ranges = ranges, N_batch = 1000, replace_step = 2)#, load_file = "starting_dataset.dat")
...
model.fit(dataset_generator, N_epochs = 100,  learning_rate = 1e-3, save_output = True, plot_function = plot, checkpoint_step = 50, print_step = 10)#, validation_file = "validation_angles.dat")
