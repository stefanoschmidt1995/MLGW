...
\stefano{Yes! The figure above was empty otherwise... Unless you strongly object, I'd keep it as it is.} \tim{Alright, then we'll keep it like this.}
...
\tim{Maybe we could add a paragraph on different neural network topologies (not the same number of units for each hidden layer) and repeat what we said about improving HMs by using separate tuning?} \stefano{Added this: how does this look?} \tim{I think it looks good.}
