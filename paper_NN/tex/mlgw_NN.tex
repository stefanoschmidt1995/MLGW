...
%Lastly, though we have not incorporated precession, we did show our approach to be viable for the relatively large range of parameters $(q,\chi_1, \chi_2)\subset [1,10]\times [-0.9,0.9]\times[-0.9,0.9]$, where previous approaches either focused solely on non-precessing spin-aligned waveforms \cite{Khan:2020fso, Chua:2018woh} or on precessing waveforms but with a parameter range $(q,\chi_1, \chi_2)\subset [1,2]\times [0.,0.8]\times\{0\}$ \cite{Thomas:2022rmc}.
