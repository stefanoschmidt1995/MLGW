...
if fit_PCA:
	create_PCA_dataset((6,5), dataset_file, PCA_dataset_folder, train_frac = 0.9)

if fit_MoE_model:
	print("Saving model to: ", model_folder)
	fit_MoE("ph", PCA_dataset_folder, model_folder, experts = 4, comp_to_fit = None, features = fifth_order, EM_threshold = 1e-2, args = None, N_train = 6000, verbose = True, test_mismatch = True)
