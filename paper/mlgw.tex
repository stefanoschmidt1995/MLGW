...
%Such results are similar to the discrepancies between state-of-the-art EOB waveforms and NR waveforms~\cite{Bohe:2016gbl, Nagar:2020pcj}. 
    ...
    \begin{minipage}{\linewidth}
        \centering
	 	\begin{minipage}{\minipagesize\linewidth}
			...
			\vskip0.3em
		    \includegraphics[width=\linewidth]{img/F_countour_mass.pdf}
		\end{minipage}\hfill
		\begin{minipage}{\minipagesize\linewidth}
		    \centering
			{\fontfamily{DejaVuSans-TLF} \fontsize{\titlefontsize}{12}\selectfont 
			...
			\vskip0.3em
		    \includegraphics[width=\linewidth]{img/mse_countour_mass.pdf}
		\end{minipage}
    \end{minipage}\hfill
    \begin{minipage}{\linewidth}
        \centering
