...
Another EOB-based model in use is the~\texttt{SEOBNR}~\cite{Taracchini:2013rva,Bohe:2016gbl} one, 
largely employed by the LIGO-Virgo collaboration. We use both 
\texttt{TEOBResumS\_SM} (that will be simply called \texttt{TEOBResumS} for simplicity in the following) 
and \texttt{SEOBNRv2}/\texttt{v4} to train different versions of the model,
...
depends only on the variables $\tilde{\boldsymbol{\vartheta}} = (q, s_1, s_2)$.
