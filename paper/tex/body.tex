...
\par
%%%%%SHOULD I SAY IT HERE OR ONLY IN THE CONCLUSIONS??
%The advantages are manifold.
%First of all, a single closed form function is available for this purpose. A significant speed up of the time to generate a waveform is in reach.
%Furthermore, a reliable ML scheme could be fed only with numerical relativity waveforms. This in principle will allow to bypass the PN approximation and to work directly with the full equations.
%A third advantage is more technical: a closed form expression for a waveform yields a closed form for the gradients of the waveforms. A gradient based sampling method can be applied to the problem to produce a substantial speed up of the parameter estimation.
\par
...
\begin{figure}
	\centering
    \includegraphics[width=\linewidth]{time_performance_hist}
	\caption{
