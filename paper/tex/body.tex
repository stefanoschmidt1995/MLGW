...
the next-to-quasi-circular parameters~\cite{Nagar:2020pcj}\footnote{This slightly worsens the EOB/NR performance that in
...
largely employed by the LIGO-Virgo collaboration.
