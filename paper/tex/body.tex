...
\begin{figure*}[t]
	\centering
    \includegraphics[width=.45\textwidth]{img/posterior_masses_source.pdf}
    \includegraphics[width=.45\textwidth]{img/final_spin_mass.pdf}
	\caption{
...
The figure is consistent with, though different from, Fig.~4 of Ref.~\cite{LIGOScientific:2018mvr}.
}
