...
\BS{[but it is not an extrapolation...]}
%
...
waveform model~\cite{Taracchini:2013rva}. \BS{[would remove this, and say in the text we also construct MLGW for SEOB]}}.
...
\BS{[to do the FFT you need uniform time spacing, so I guess you need an interpolation before the FFT. in other models this is a significant fraction of the cost]}
\par
...
\begin{figure*}[t]
	...
	Fig.~\cite{fig:gwtc1-summary} above are practically negligible.}
        \BS{Any chance to merger this table with the other? e.g. putting it horizontal?}
...
\begin{figure}[t]
	...
	The contours enclose the $90\%$ credible regions.}
        \BS{can we have betetr legends in the plots and write in the panels TEOBResumS and SEOBNRv4?}
