...
The figure shall be compared with figure 10 in \cite{LIGOScientific:2018mvr} (left panel).
}
...
The figure shall be compared with figure 10 in \cite{LIGOScientific:2018mvr} (right panel).
}
