...
state-of-the-art waveforms generators. \bs{[would say] to ACCELERATE
  waveform generation}
...
waveform
data~\cite{Gabbard:2017lja,George:2017pmj,George:2017vlv,Rebei:2018lzh,Khan:2020foe}. \BS{[check
...
outside this NR-information domain (e.g. large mass ratios and spins). 
...
This model used several hundreds (though most of them are redundant) 
...
models~\cite{LIGOScientific:2018mvr}, though with some distinguo: 
