...
GW transient catalog (GWTC-1) \oldnewtxt{to find consistent results at  a fraction of the cost}{. We find broadly consistent results with previous analyses at a fraction of the cost, although the analysis with spin aligned waveforms gives systematic larger values of the effective spins with respect to analysis with precessing waveforms}.
