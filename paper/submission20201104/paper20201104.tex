...
We then vary $N_{\rm grid}$ and $\alpha$ and report the resulting mismatch $\mathcal{F}[\mathbf{f}_{\rm EOB}, \mathbf{f}_{N_{\rm grid}, \alpha}]$ in Fig.~\ref{fig:fig02.N_grid}.
%%
\begin{figure}[!t]
	\centering
	\includegraphics[width=\linewidth,keepaspectratio]{fig02.N_grid}
...
\begin{figure}[!t]
    ...
    \begin{minipage}{.5\linewidth}
        \centering
        \includegraphics[width=\linewidth]{fig03a.MoE_mismatch_amp}
    \end{minipage}\hfill
    \begin{minipage}{.5\linewidth}
        \centering
        \includegraphics[width=\linewidth]{fig03b.MoE_mismatch_ph}
    \end{minipage}
...
\begin{figure}[!t]
    ...
    \begin{minipage}{.5\linewidth}
		\centering
	    \includegraphics[width=\linewidth]{fig04a.mismatch_MoE_vs_PCA_amp}
	\end{minipage}\hfill
    \begin{minipage}{.5\linewidth}
		\centering
	    \includegraphics[width=\linewidth]{fig04b.mismatch_MoE_vs_PCA_ph}
	\end{minipage}
...
In Fig.~\ref{fig:fig05.N_train} we report train and test value of mismatch and mean squared error (MSE) of the 
...
\begin{figure}
	\centering
    \includegraphics[width=\linewidth]{fig05.N_train}
...
\begin{figure}
	\centering
    \includegraphics[width=\linewidth]{fig06.F_hist}
	...
	\label{fig:fig06.F_hist}
\end{figure}
%%%%
We compute the mismatch between \texttt{mlgw} and the underlying training model (\texttt{TEOBResumS}) for a large number of WFs
and we report our results in the histogram in Fig.~\ref{fig:fig06.F_hist}. The mismatch distribution has 
    ...
    \begin{minipage}{\linewidth}
        \centering
	 	\begin{minipage}{\minipagesize\linewidth}
			...
			\vskip0.3em
		    \includegraphics[width=\linewidth]{fig07a.F_countour_mass}
		\end{minipage}\hfill
		\begin{minipage}{\minipagesize\linewidth}
		    \centering
			{\fontfamily{DejaVuSans-TLF} \fontsize{\titlefontsize}{12}\selectfont 
			...
			\vskip0.3em
		    \includegraphics[width=\linewidth]{fig07b.mse_countour_mass}
		\end{minipage}
    \end{minipage}\hfill
    \begin{minipage}{\linewidth}
        \centering
	 	\begin{minipage}{\minipagesize\linewidth}
		    \centering
		    \includegraphics[width=\linewidth]{fig07c.F_countour_spins}
		\end{minipage}\hfill
		\begin{minipage}{\minipagesize\linewidth}
		    \centering
		    \includegraphics[width=\linewidth]{fig07d.mse_countour_spins}
		\end{minipage}
    \end{minipage}\hfill
    \begin{minipage}{\linewidth}
        \centering
	 	\begin{minipage}{\minipagesize\linewidth}
		    \centering
		    \includegraphics[width=\linewidth]{fig07e.F_countour_q_s1}
		\end{minipage}\hfill
		\begin{minipage}{\minipagesize\linewidth}
		    \centering
		    \includegraphics[width=\linewidth]{fig07f.mse_countour_q_s1}
		\end{minipage}
    \end{minipage}
...
\begin{figure}
	...
	\begin{minipage}{\factor\linewidth}
	    \includegraphics[width=\linewidth]{fig08a.compare_time_hist_5}
	\end{minipage}\hfill
	\begin{minipage}{\factor\linewidth}
	    \includegraphics[width=\linewidth]{fig08b.compare_time_hist_20}
	\end{minipage}
...
\begin{figure}
	\centering
	\begin{minipage}{\factor\linewidth}
	    \includegraphics[width=\linewidth]{fig09a.time_performance_hist_ROM_5_2048}
	\end{minipage}\hfill
	\begin{minipage}{\factor\linewidth}
	    \includegraphics[width=\linewidth]{fig09b.time_performance_hist_ROM_20_2048}
	\end{minipage}
